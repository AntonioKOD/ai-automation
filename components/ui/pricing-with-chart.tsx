					...
					<div className="space-y-4">
						<div>
							...
							<p className="text-muted-foreground text-sm">
								Best for single automations and small projects
							</p>
						</div>
						...
						<ul className="text-muted-foreground space-y-3 text-sm">
							{[
								...
								'Basic AI Automations (lead capture, auto-emails, form-responses)',
				...
				<div className="z-10 grid gap-8 overflow-hidden p-6 md:col-span-4 lg:grid-cols-2">
					...
					<div className="relative w-full">
						...
						<ul className="text-muted-foreground mt-4 space-y-3 text-sm">
							{[
								'Advanced AI integrations (chatbots, content schedulers, CRM integrations)',
								'Ecommerce or booking system integration',
